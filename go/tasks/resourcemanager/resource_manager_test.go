...
func TestNoopResourceManager_AllocateResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			n := NoopResourceManager{}
			got, err := AllocateResource(tt.args.ctx, tt.args.namespace, tt.args.allocationToken)
			if (err != nil) != tt.wantErr {
...
func TestNoopResourceManager_ReleaseResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			n := NoopResourceManager{}
			if err := ReleaseResource(tt.args.ctx, tt.args.namespace, tt.args.allocationToken); (err != nil) != tt.wantErr {
