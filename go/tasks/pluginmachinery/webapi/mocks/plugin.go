...
func (_m *Plugin) OnCreate(ctx context.Context, tCtx webapi.TaskExecutionContext) *Plugin_Create {
...
func (_m *Plugin) Create(ctx context.Context, tCtx webapi.TaskExecutionContext) (interface{}, error) {
	ret := _m.Called(ctx, tCtx)

	var r0 interface{}
	if rf, ok := ret.Get(0).(func(context.Context, webapi.TaskExecutionContext) interface{}); ok {
		r0 = rf(ctx, tCtx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Plugin) OnGetConfig() *Plugin_GetConfig {
	c := _m.On("GetConfig")
	return &Plugin_GetConfig{Call: c}
}
...
func (_m *Plugin) OnResourceRequirements(ctx context.Context, tCtx webapi.TaskExecutionContext) *Plugin_ResourceRequirements {
...
func (_m *Plugin) ResourceRequirements(ctx context.Context, tCtx webapi.TaskExecutionContext) (core.ResourceNamespace, core.ResourceConstraintsSpec, error) {
	ret := _m.Called(ctx, tCtx)

	var r0 core.ResourceNamespace
	if rf, ok := ret.Get(0).(func(context.Context, webapi.TaskExecutionContext) core.ResourceNamespace); ok {
		r0 = rf(ctx, tCtx)
	} else {
	...
	if rf, ok := ret.Get(1).(func(context.Context, webapi.TaskExecutionContext) core.ResourceConstraintsSpec); ok {
		r1 = rf(ctx, tCtx)
	} else {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, webapi.TaskExecutionContext) error); ok {
		r2 = rf(ctx, tCtx)
	} else {
		r2 = ret.Error(2)
	}
