...
type TaskExecutionContext_GetTaskRefreshIndicator struct {
	*mock.Call
}

func (_m TaskExecutionContext_GetTaskRefreshIndicator) Return(_a0 func()) *TaskExecutionContext_GetTaskRefreshIndicator {
	return &TaskExecutionContext_GetTaskRefreshIndicator{Call: _m.Call.Return(_a0)}
}

func (_m *TaskExecutionContext) OnGetTaskRefreshIndicator() *TaskExecutionContext_GetTaskRefreshIndicator {
	c := _m.On("GetTaskRefreshIndicator")
	return &TaskExecutionContext_GetTaskRefreshIndicator{Call: c}
}

func (_m *TaskExecutionContext) OnGetTaskRefreshIndicatorMatch(matchers ...interface{}) *TaskExecutionContext_GetTaskRefreshIndicator {
	c := _m.On("GetTaskRefreshIndicator", matchers...)
	return &TaskExecutionContext_GetTaskRefreshIndicator{Call: c}
}
