...
type TaskExecutionContext_AllocateResource struct {
	*mock.Call
}

func (_m TaskExecutionContext_AllocateResource) Return(_a0 core.AllocationStatus, _a1 error) *TaskExecutionContext_AllocateResource {
	return &TaskExecutionContext_AllocateResource{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *TaskExecutionContext) OnAllocateResource(ctx context.Context, namespace core.ResourceNamespace, allocationToken string, constraintsSpec core.ResourceConstraintsSpec) *TaskExecutionContext_AllocateResource {
	c := _m.On("AllocateResource", ctx, namespace, allocationToken, constraintsSpec)
	return &TaskExecutionContext_AllocateResource{Call: c}
}

func (_m *TaskExecutionContext) OnAllocateResourceMatch(matchers ...interface{}) *TaskExecutionContext_AllocateResource {
...
func (_m *TaskExecutionContext) AllocateResource(ctx context.Context, namespace core.ResourceNamespace, allocationToken string, constraintsSpec core.ResourceConstraintsSpec) (core.AllocationStatus, error) {
...
type TaskExecutionContext_ReleaseResource struct {
	*mock.Call
}

func (_m TaskExecutionContext_ReleaseResource) Return(_a0 error) *TaskExecutionContext_ReleaseResource {
	return &TaskExecutionContext_ReleaseResource{Call: _m.Call.Return(_a0)}
}

func (_m *TaskExecutionContext) OnReleaseResource(ctx context.Context, namespace core.ResourceNamespace, allocationToken string) *TaskExecutionContext_ReleaseResource {
	c := _m.On("ReleaseResource", ctx, namespace, allocationToken)
	return &TaskExecutionContext_ReleaseResource{Call: c}
}

func (_m *TaskExecutionContext) OnReleaseResourceMatch(matchers ...interface{}) *TaskExecutionContext_ReleaseResource {
	c := _m.On("ReleaseResource", matchers...)
	return &TaskExecutionContext_ReleaseResource{Call: c}
}

// ReleaseResource provides a mock function with given fields: ctx, namespace, allocationToken
func (_m *TaskExecutionContext) ReleaseResource(ctx context.Context, namespace core.ResourceNamespace, allocationToken string) error {
