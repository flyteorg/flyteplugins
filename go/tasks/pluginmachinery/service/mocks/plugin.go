...
import (
	...
	service "github.com/lyft/flyteplugins/go/tasks/pluginmachinery/service"
)
...
func (_m Plugin_Create) Return(_a0 service.RemoteResourceKey, _a1 error) *Plugin_Create {
...
func (_m *Plugin) Create(ctx context.Context, tCtx service.PluginContext) (service.RemoteResourceKey, error) {
	ret := _m.Called(ctx, tCtx)

	var r0 service.RemoteResourceKey
	if rf, ok := ret.Get(0).(func(context.Context, service.PluginContext) service.RemoteResourceKey); ok {
		r0 = rf(ctx, tCtx)
	} else {
		r0 = ret.Get(0).(service.RemoteResourceKey)
	}
...
func (_m *Plugin) OnDelete(ctx context.Context, key service.RemoteResourceKey) *Plugin_Delete {
...
func (_m *Plugin) Delete(ctx context.Context, key service.RemoteResourceKey) error {
	ret := _m.Called(ctx, key)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, service.RemoteResourceKey) error); ok {
		r0 = rf(ctx, key)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m Plugin_Get) Return(_a0 service.RemoteResource, _a1 error) *Plugin_Get {
	return &Plugin_Get{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *Plugin) OnGet(ctx context.Context, key service.RemoteResourceKey) *Plugin_Get {
	c := _m.On("Get", ctx, key)
...
func (_m *Plugin) Get(ctx context.Context, key service.RemoteResourceKey) (service.RemoteResource, error) {
	ret := _m.Called(ctx, key)

	var r0 service.RemoteResource
	if rf, ok := ret.Get(0).(func(context.Context, service.RemoteResourceKey) service.RemoteResource); ok {
		r0 = rf(ctx, key)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(service.RemoteResource)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, service.RemoteResourceKey) error); ok {
		r1 = rf(ctx, key)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m Plugin_GetBatch) Return(_a0 service.RemoteResource, _a1 error) *Plugin_GetBatch {
	return &Plugin_GetBatch{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *Plugin) OnGetBatch(ctx context.Context, key ...service.RemoteResourceKey) *Plugin_GetBatch {
...
func (_m *Plugin) GetBatch(ctx context.Context, key ...service.RemoteResourceKey) (service.RemoteResource, error) {
...
func (_m *Plugin) OnGetStatus(ctx context.Context, tCtx service.PluginContext, resource service.RemoteResource) *Plugin_GetStatus {
...
func (_m *Plugin) GetStatus(ctx context.Context, tCtx service.PluginContext, resource service.RemoteResource) (core.PhaseInfo, error) {
	ret := _m.Called(ctx, tCtx, resource)

	var r0 core.PhaseInfo
	if rf, ok := ret.Get(0).(func(context.Context, service.PluginContext, service.RemoteResource) core.PhaseInfo); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, service.PluginContext, service.RemoteResource) error); ok {
