...
// OutputDataSandbox is an autogenerated mock type for the OutputDataSandbox type
...
func (_m *OutputDataSandbox) GetOutputDataSandboxPath() storage.DataReference {
	ret := _m.Called()
