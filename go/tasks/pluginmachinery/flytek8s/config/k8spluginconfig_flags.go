...
func (cfg K8sPluginConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Int64(fmt.Sprintf("%v%v", prefix, "maxSystemLevelTimeout"), defaultK8sConfig.MaxSystemLevelTimeout, "Value to be used for system level timeouts in minutes.")
	return cmdFlags
}
