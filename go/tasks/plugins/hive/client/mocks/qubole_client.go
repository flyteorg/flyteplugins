...
import (
	...
	client "github.com/lyft/flyteplugins/go/tasks/plugins/hive/client"
...
func (_m *QuboleClient) OnExecuteHiveCommand(ctx context.Context, commandStr string, timeoutVal uint32, clusterLabel string, accountKey string, tags []string) *QuboleClient_ExecuteHiveCommand {
	c := _m.On("ExecuteHiveCommand", ctx, commandStr, timeoutVal, clusterLabel, accountKey, tags)
...
type QuboleClient_GetLogLinkPath struct {
	*mock.Call
}

func (_m QuboleClient_GetLogLinkPath) Return(_a0 *url.URL, _a1 error) *QuboleClient_GetLogLinkPath {
	return &QuboleClient_GetLogLinkPath{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *QuboleClient) OnGetLogLinkPath(ctx context.Context, commandID string) *QuboleClient_GetLogLinkPath {
	c := _m.On("GetLogLinkPath", ctx, commandID)
	return &QuboleClient_GetLogLinkPath{Call: c}
}

func (_m *QuboleClient) OnGetLogLinkPathMatch(matchers ...interface{}) *QuboleClient_GetLogLinkPath {
	c := _m.On("GetLogLinkPath", matchers...)
	return &QuboleClient_GetLogLinkPath{Call: c}
}
